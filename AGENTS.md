...
| **`my-markdown`** | [`.agents/skills/my-markdown/SKILL.md`](.agents/skills/my-markdown/SKILL.md) | Referência canônica para formatação `.md` (frontmatter, wikilinks, tags, callouts). Usar SEMPRE que criar/editar uma nota — a skill `my-memory` aponta para esta para markup detalhado. |
