...
> **Esta é a skill canônica de uso do My-Memory.** Qualquer agente (humano ou IA) que precise instalar, configurar, usar ou documentar algo neste projeto deve seguir este guia. Para regras estritas de formatação de `.md` (wikilinks, tags, frontmatter), consulte a skill [`memory-md`](.agents/skills/memory-md/SKILL.md) — ela é a referência canônica de markup.
...
> [!important]
> **Esta seção é a parte mais importante para quem cria `.md`.** Regras detalhadas de markup vivem na skill [`memory-md`](.agents/skills/memory-md/SKILL.md) — esta é só a visão geral.
...
### Skills irmãs
- [`memory-md`](.agents/skills/memory-md/SKILL.md) — **canônica de formatação `.md`** (frontmatter, wikilinks, tags, callouts, embeds)
