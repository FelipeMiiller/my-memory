 ...
 *     (page reload, app re-launch) honour it via `i18n/index.ts`.
 *
 * Built on shadcn/ui primitives (Button + DropdownMenu from Radix).
 * The DropdownMenu component is a thin local wrapper to avoid pulling
 * the full `@radix-ui/react-dropdown-menu` dep until Phase 2 hardens
 * the shadcn/ui suite — keeping Phase 1 dependencies minimal.
 */
