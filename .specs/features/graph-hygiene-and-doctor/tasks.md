...
**Done when**:
- [x] Criar docs/adr/013-higiene-de-grafo-pruning-e-doctor.md no formato MADR
- [x] Atualizar docs/adr/README.md, docs/CLI_GUIDE.md e docs/REPOSITORY_BRAIN.md
- [x] Atualizar .specs/STATE.md e gerar validation.md
