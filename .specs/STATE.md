...
- **In-progress**: none
- **Next step**: Viewer rewrite (Vite + Vanilla TS) conforme ADR-037. Investigar parser + EARS notation (dead links). Considerar B2 edit-ability quando começar ADR-037.
- **Blockers**: none
- **Branch**: develop
